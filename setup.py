...
setup(
    ...
    data_files=[
        ...
        # Upstream-only TurtleBot3/ROS 2 service examples. These units invoke
        # /opt/ros packages directly and contain no Flyto2 runtime.
        (f"share/{PACKAGE_NAME}/native_ros2", glob("deploy/native_ros2/*")),
